...
export const tablets: Product[] = [
  ...
  {
    // name должен совпадать с живой таблицей (иначе обезличивание при замене
    // в превью не находит соответствие в kpNameMap → утечка бренда).
    id: 'tab-honor-pad10',
    name: 'Honor Pad 10',
    kpName: 'Планшет Android 12.1\'\', 8/256Гб',
    category: 'tablet',
    company: 'inno',
    ...
    sellPrice: 34000,
    margin: 30.8,
    specs: '12.1" LCD, 8/256Гб',
  },
  {
    id: 'tab-redmi-pad2pro',
    name: 'Redmi Pad 2 Pro',
    kpName: 'Планшет Android 12.1\'\', 6/128Гб',
    category: 'tablet',
    company: 'inno',
